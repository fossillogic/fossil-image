...
FOSSIL_TEST_GROUP(c_image_color_tests) {
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_brightness_increase);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_brightness_decrease);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_contrast_increase);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_contrast_reduce);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_gamma_basic);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_gamma_invalid);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_hsv_adjust_hue_shift);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_hsv_adjust_saturation);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_channel_swap_basic);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_channel_swap_invalid);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_to_grayscale_basic);
    FOSSIL_ADD_TEST(c_image_color_fixture, c_test_image_color_to_grayscale_already_gray);

    FOSSIL_ADD_SUITE(c_image_color_fixture);
} // end of tests
