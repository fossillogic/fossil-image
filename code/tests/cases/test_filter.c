...
FOSSIL_TEST_GROUP(c_image_filter_tests) {
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_convolve3x3_basic);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_convolve3x3_null_image);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_blur_basic);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_blur_large_radius);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_sharpen_basic);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_edge_basic);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_emboss_basic);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_blur_too_small_image);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_sharpen_null_image);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_edge_null_image);
    FOSSIL_ADD_TEST(c_image_filter_fixture, c_test_image_filter_emboss_null_image);

    FOSSIL_ADD_SUITE(c_image_filter_fixture);
} // end of tests
