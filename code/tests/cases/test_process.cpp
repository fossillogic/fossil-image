...
FOSSIL_SUITE(cpp_image_process_fixture);

FOSSIL_SETUP(cpp_image_process_fixture) {
    // Setup the test fixture
}

FOSSIL_TEARDOWN(cpp_image_process_fixture) {
...
FOSSIL_TEST(cpp_test_image_process_create_basic) {
...
FOSSIL_TEST(cpp_test_image_process_create_zero_size) {
    fossil_image_t *img = fossil::image::Process::create(0, 0, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_ITS_FALSE(img != NULL);
}

FOSSIL_TEST(cpp_test_image_process_destroy_basic) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    fossil::image::Process::destroy(img);
...
FOSSIL_TEST(cpp_test_image_process_resize_basic) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    memset(img->data, 123, img->size);
    bool ok = fossil::image::Process::resize(img, 4, 4, FOSSIL_INTERP_NEAREST);
    ASSUME_ITS_TRUE(ok);
...
FOSSIL_TEST(cpp_test_image_process_resize_invalid) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    bool ok = fossil::image::Process::resize(img, 0, 0, FOSSIL_INTERP_NEAREST);
    ASSUME_ITS_FALSE(ok);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_resize_null_image) {
    bool ok = fossil::image::Process::resize(NULL, 4, 4, FOSSIL_INTERP_NEAREST);
    ASSUME_ITS_FALSE(ok);
}

FOSSIL_TEST(cpp_test_image_process_crop_basic) {
    fossil_image_t *img = fossil::image::Process::create(4, 4, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    memset(img->data, 50, img->size);
    bool ok = fossil::image::Process::crop(img, 1, 1, 2, 2);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img->width, 2);
    ASSUME_ITS_EQUAL_I32(img->height, 2);
    fossil::image::Process::destroy(img);
...
FOSSIL_TEST(cpp_test_image_process_crop_out_of_bounds) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    bool ok = fossil::image::Process::crop(img, 1, 1, 5, 5);
    ASSUME_ITS_FALSE(ok);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_flip_horizontal) {
    fossil_image_t *img = fossil::image::Process::create(2, 1, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    img->data[0] = 10; img->data[3] = 20;
    bool ok = fossil::image::Process::flip(img, true, false);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img->data[0], 20);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_flip_vertical) {
    fossil_image_t *img = fossil::image::Process::create(1, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    img->data[0] = 30; img->data[3] = 40;
    bool ok = fossil::image::Process::flip(img, false, true);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img->data[0], 40);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_rotate_90) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    img->data[0] = 1; img->data[3] = 2; img->data[6] = 3; img->data[9] = 4;
    bool ok = fossil::image::Process::rotate(img, 90.0f);
    ASSUME_ITS_TRUE(ok);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_blend_basic) {
    fossil_image_t *img1 = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    fossil_image_t *img2 = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_ITS_TRUE(img1 && img2);
    memset(img1->data, 0, img1->size);
    memset(img2->data, 255, img2->size);
    bool ok = fossil::image::Process::blend(img1, img2, 0.5f);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img1->data[0], 128);
    fossil::image::Process::destroy(img1);
    fossil::image::Process::destroy(img2);
}

FOSSIL_TEST(cpp_test_image_process_blend_mismatched_size) {
    fossil_image_t *img1 = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    fossil_image_t *img2 = fossil::image::Process::create(3, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_ITS_TRUE(img1 && img2);
    bool ok = fossil::image::Process::blend(img1, img2, 0.5f);
    ASSUME_ITS_FALSE(ok);
    fossil::image::Process::destroy(img1);
...
FOSSIL_TEST(cpp_test_image_process_composite_basic) {
    fossil_image_t *dst = fossil::image::Process::create(4, 4, FOSSIL_PIXEL_FORMAT_RGB24);
    fossil_image_t *overlay = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_ITS_TRUE(dst && overlay);
    memset(dst->data, 0, dst->size);
    memset(overlay->data, 255, overlay->size);
    bool ok = fossil::image::Process::composite(dst, overlay, 1, 1, 0.5f);
    ASSUME_ITS_TRUE(ok);
    fossil::image::Process::destroy(dst);
    fossil::image::Process::destroy(overlay);
}

FOSSIL_TEST(cpp_test_image_process_grayscale_basic) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_RGB24);
    ASSUME_NOT_CNULL(img);
    ...
    bool ok = fossil::image::Process::grayscale(img);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img->channels, 1);
    fossil::image::Process::destroy(img);
}

FOSSIL_TEST(cpp_test_image_process_threshold_basic) {
    ...
    bool ok = fossil::image::Process::threshold(img, 128);
    ASSUME_ITS_TRUE(ok);
...
FOSSIL_TEST(cpp_test_image_process_invert_basic) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_GRAY8);
    ASSUME_NOT_CNULL(img);
    img->data[0] = 0; img->data[1] = 128; img->data[2] = 255; img->data[3] = 64;
    bool ok = fossil::image::Process::invert(img);
    ASSUME_ITS_TRUE(ok);
...
FOSSIL_TEST(cpp_test_image_process_normalize_basic) {
    fossil_image_t *img = fossil::image::Process::create(2, 2, FOSSIL_PIXEL_FORMAT_GRAY8);
    ASSUME_NOT_CNULL(img);
    img->data[0] = 50; img->data[1] = 100; img->data[2] = 150; img->data[3] = 200;
    bool ok = fossil::image::Process::normalize(img);
    ASSUME_ITS_TRUE(ok);
    ASSUME_ITS_EQUAL_I32(img->data[0], 0);
